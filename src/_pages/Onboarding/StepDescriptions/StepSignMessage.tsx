...
export default function StepSignMessage() {
  ...
  const whyIsRequired = (
    <>
      ...
      window. Please click the button below to sign a free test transaction. Many DeFi applications do this so the user can prove that they are in control of a wallet address.
    </>
  );
  const notes = (
    <>
      This transaction doesn&apos;t incur a gas fee. However, in future, transactions will
