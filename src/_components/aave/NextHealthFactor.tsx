...
export default function NextHealthFactor({ reserve, amount }: {reserve: ComputedReserveData, amount?: string}) {
  const userSummary = useAaveUserSummary();
  const [healthFactorNumber, setHealthFactorNumber] = useState<string | undefined>(userSummary?.healthFactor);
  useEffect(() => {
